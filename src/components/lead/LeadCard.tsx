            ...
            <div className="relative h-[22px] min-w-[40px]">
              ...
              >
                ...
                <button
                  ...
                  className="p-1 text-gray-400 transition-all duration-200 rounded-full hover:bg-gray-50 group"
                >
                  <svg className="w-3 h-3 transition-colors duration-200 group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button
                  ...
                  className="p-1 text-gray-400 transition-all duration-200 rounded-full hover:bg-gray-50 group"
                >
                  <svg className="w-3 h-3 transition-colors duration-200 group-hover:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
